<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		$('#modal_login').on('click', '.btn-ok', function () 
		{
			...
			var option = "Penjualan/Point-of-Sale/checklogin/";
			...
			paramArr.push({name:'i_username', value:i_username});
			paramArr.push({name:'i_password', value:i_password});
			...
			$.ajax({
				...
				success: function (data) {
					if (data.status=='200') 
					{
						...
						if(discount_percent > data.type_karyawan_maxdiskon)
						{
							alert("Gagal, Max Diskon untuk user "+i_username+" adalah "+data.type_karyawan_maxdiskon+"%");
							return false;
						}
						else
						{
		...
		{			
			...
			if(current_discount_item > sales_total_item)
			{
			 ...
			 {
				// var bisst_storage_booking_detail = JSON.parse(localStorage.getItem('sales_booking_detail'));
				var url = "<?php echo base_url()?>Penjualan/Point-of-Sale/popmodal_form_login";
        ...
        $.fn.refreshChart = function () {
            ...
            $.each(storage_sales_detail, function (index, value) {
                ...
                html += '<td style="text-align: right;">' +
                        ...
                        data-total="'+item_total_before_discount+'" class="btn btn-primary btn-sm btn-show-discount-item" data-toggle="modal" data-target=".bs-modal-disc-item">\
            ...
            $.each(storage_booking_detail, function (index, value) {
                ...
                html += '<td style="text-align: right;">' +
                        ...
                        data-total="'+item_total_before_discount_booking+'" data-status-gudang="'+data_status_ambil+'" class="btn btn-primary btn-sm btn-show-discount-item-booking" data-toggle="modal" data-target=".bs-modal-disc-item">\
            ...
            var cartDiscountPercent = cartDiscount/cartSubTotal*100;
        ...
        $("body").on("click", ".btn-remove-cart", function (e) {
            ...
            if (status_booking == 1) {
              ...
              $.each(storage_sales_detail, function (index, value) {
                  ...
                  if (value.item_id == item_id) {
                      storage_sales_detail.splice(index, 1);
        ...
        $("body").on("click", ".btn-show-discount-item", function (e) {
			...
			// var url = "<?php echo base_url()?>Penjualan/Point-of-Sale/popmodal_form_login3";
            // $('#modal_login').modal('show').find('.modal-content').load(url);
            // e.preventDefault();
        });
        ...
        $("#input-discount-percent").keyup(function () {
            ...
            // if (this_value>=5) {
              ...
              // } else {
                ...
                var nominal = this_value/100*total_sales_detail_;
              // }
            // }
        ...
        $.fn.getItems = function (kategori_id = null) {
          ...
          $.ajax({
            ...
            success   : function(data){
              ...
              $.each(data.itemsall, function (index, value) {
                var stok_gudang_jumlah = value.stok_gudang_jumlah;
                items.push(value);
        ...
        $.fn.getPromo = function(){
          ...
          $.ajax({
            type      : "POST",
            data      : {kategori_id:kategori_id},
            url       : base_url+"Penjualan/Point-of-Sale/getPromo",
            dataType  : "JSON",
            cache     : false,
            success   : function(data){
              var html = '';
