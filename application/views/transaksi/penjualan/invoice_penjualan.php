...
<body onload=print()>
  ...
  <table style="width:100%;">
    ...
    <tr>
			...
			<td align="right"><strong><?php echo number_format($total_diskon_item+$transaksi->penjualan_all_discount,"0", ",", ".")?></strong></td>
		</tr>
    <tr>
    ...
    <tr>
			...
			<!--<td align="right"><strong><?php //echo number_format($totalhargitem-$totalhargatanpappn,"0", ",", ".")?></strong></td>-->			<td align="right"><strong><?php echo number_format(($totalhargatanpappn*(10/100)),"0", ",", ".")?></strong></td>
		</tr>
  </table>
	</page>
</body>
