                                          ...
                                          <div class="row" id="modal_body_col" style="border:none;">
                                            ...
                                            <div class="col-md-6">
                                              ...
                                              <div style="display: none;" class="box-sales" id="box-edc">
                                                  ...
                                                  <select name="i_edc" id="i_edc" class="form-control">
                                                  </select>
                                              </div>
                                              <!-- END -->
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $.ajax({
      type    : "POST",
      url     : "<?php echo base_url()?>Penjualan/Point-of-Sale/getEdc",
      dataType: "JSON",
      cache   : false,
      success : function (data){
        for (var i = 0; i < data.length; i++) {
          htmlkategori += "<option value="+data[i].data_id+">"+data[i].data_nama+"</option>";
        }
        document.getElementById('i_edc').innerHTML = "";
        document.getElementById('i_edc').innerHTML = htmlkategori;
      }
    });
