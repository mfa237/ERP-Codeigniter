...
function editData(id){
  ...
  $.ajax({
    ...
    success:function(data){
        ...
        document.getElementById("daterange").value  = data.datapromo.promo_date;
...
function deleteData(id) {
  swal({
    ...
    $.ajax({
      url: '<?php echo base_url();?>Master-Data/Master-Promo/deleteData/',
      data: 'id='+id,
      type: 'POST',
      dataType: 'json',
      success: function (data) {
...
function aktifData(id) {
  swal({
    ...
    $.ajax({
      url: '<?php echo base_url();?>Master-Data/Master-Promo/aktifData/',
      data: 'id='+id,
      type: 'POST',
      dataType: 'json',
      success: function (data) {
