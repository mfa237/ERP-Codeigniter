                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="default-table">
                                        <thead>
                                            <tr>
                                                <th> No </th>
                                                <th> Nama Tipe Karyawan </th>												                                                <th> Otorisasi Max. Diskon </th>
                                                <th> Status </th>
                                                <th> Action </th>
                                            </tr>
                                        </thead>
            ...
            function searchData() { 
                $('#default-table').DataTable({
                    ...
                    "columns": [
                      ...
                      {"name": "type_karyawan_nama"},					                        {"name": "type_karyawan_maxdiskon"},
                ...
                $.ajax({
                  ...
                  success:function(data){
                    for(var i=0; i<data.val.length;i++){
                      ...
                      document.getElementsByName("type_karyawan_nama")[0].value = data.val[i].type_karyawan_nama;					                        document.getElementsByName("type_karyawan_maxdiskon")[0].value = data.val[i].type_karyawan_maxdiskon;
