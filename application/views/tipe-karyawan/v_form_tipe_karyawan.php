<!-- BEGIN FORM-->
    <form action="#" id="formAdd" class="form-horizontal" method="post">
        <div class="form-body">
            ...
            </div>									<div class="form-group">                <label class="control-label col-md-4">Otorisasi Max Diskon                </label>                <div class="col-md-8">                    <div class="input-icon right">                        <i class="fa"></i>                        <input type="text" class="form-control telp" name="type_karyawan_maxdiskon" value=0 /> </div>                </div>            </div>
