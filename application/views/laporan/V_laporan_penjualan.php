                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <form action="<?php echo base_url() ?>Laporan/penjualan" id="formDataLHKB" class="form-horizontal" method="GET">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-icon right">
                                                ...
                                                <div class="input-group input-large date-picker input-daterange" data-date="10/11/2012" data-date-format="mm/dd/yyyy">
                                                    ...
                                                    <input type="text" class="form-control hidden" name="from_tanggal" id="from_tanggal">

                                                    <span class="input-group-addon hidden"> s/d </span>

                                                    <input type="text" class="form-control hidden" name="to_tanggal" id="to_tanggal"> 
                                        ...
                                        <div class="row hidden">
                                          ...
                                          <div class="form-group">
                                            <div class="col-md-4">
                                              <div class="input-icon right">
                                                <input type="text" class="form-control" id="daterange" name="daterange" value="" disabled />
                                              </div>
                                            </div>
                                            <div class="col-md-4">
                                              <?php echo $this->input->get("daterange"); ?>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-icon right">
                                                ...
                                                <div class="input-group input-large">
                                                    <!-- <select class="form-control select2" name="category_2_id" id="m_jenis_barang_id">
                                                        <option value="">- Pilih -</option>
                                                        <?php //if (isset($kategori) && is_array($kategori) && !empty($kategori)): ?>
                                                            <?php //foreach ($kategori as $key => $value): ?>
                                                                <option value="<?php //echo $value["category_2_id"] ?>"><?php //echo $value["category_2_nama"] ?></option>
                                                            <?php //endforeach ?>
                                                        <?php //endif ?>
                                                    </select> -->
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url()."Laporan/penjualan?daterange=".$this->input->get("daterange")."&from_tanggal=".$this->input->get("from_tanggal")."&to_tanggal=".$this->input->get("to_tanggal")."&m_jenis_barang_id=".$this->input->get("m_jenis_barang_id")."&m_category_2_id=".$value["category_2_id"] ?>">
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url()."Laporan/penjualan?daterange=".$this->input->get("daterange")."&from_tanggal=".$this->input->get("from_tanggal")."&to_tanggal=".$this->input->get("to_tanggal")."&m_jenis_barang_id=".$value["m_jenis_barang_id"] ?>">
                                                                <span class="title">
