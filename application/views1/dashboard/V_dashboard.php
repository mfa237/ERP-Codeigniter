                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 white" href="#">
                                ...
                                <div class="details">
                                    <div class="number">
                                        <span data-counter="counterup" data-value="0" id="achievement">0</span></div>
                                    <div class="desc"> Guest Count </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 white" href="#">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc">  Sales Count </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 white" href="#">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc">Sales Average </div>
                                </div>
                            </a>
                        </div>
                    </div>
